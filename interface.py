...
class Calculator(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora Py')
        ...
        self.add_btn(
            ...
            'background: #d5580d; color: #fff; fonte-weight: 700'
        )
        ...
        self.add_btn(
            ...
            'background: #13823a; color: #fff; fonte-weight: 700'
        )
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_equal,
            'background: #095177; color: #fff; fonte-weight: 700'
        )
